                    ...
                    <table class="table table-striped table-bordered">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <button type="button" id="viewBooking" class="btn-sm btn-primary" data-date="{{$book->book_date}}" data-id="{{$book->id}}" data-toggle="modal" data-target="#viewBookModal"> <span class="ti-eye"></span></button>
                                </td>
                                <td>
...
<div class="modal fade" id="viewBookModal" tabindex="-1" aria-labelledby="viewBookModalLabel" aria-hidden="true">
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title align-center" id="viewBookModalLabel">Booking For <span class="viewDateFor"></span> </h5>
        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
          <span aria-hidden="true">&times;</span>
        </button>
      </div>
